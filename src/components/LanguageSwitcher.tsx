  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-sm font-medium text-[#181D27] hover:bg-transparent transition-colors cursor-pointer"
      >
        <img
